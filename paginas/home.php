...
<<<<<<< HEAD
  <div class="carousel-inner col-9 container mt-1">
    <div class="carousel-item active">
      <img class="d-block w-100" src="imagens/Jogos/sifu.jpeg" alt="Primeiro Slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="imagens/pagina/curse/banner01.jpg" alt="Segundo Slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="imagens/Jogos/darksoulsbanner.jpg" alt="Terceiro Slide">
=======
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="imagens/Jogos/imagem1.jpg" alt="Segundo Slide">
    </div>
    <div class="carousel-item">
  ...
  <div class="col">
    <div class="card h-100 container-fluid bg-dark">
      ...
      <div class="card-body">
        ...
        <p class="card-text" style="color:#BEBEBE;">Entre no mundo perigoso e cheio de ação de Rua do Samurai, um jogo de combate intenso onde você assume o papel de um samurai solitário, determinado a livrar sua cidade da ameaça de bandidos implacáveis.</p>
      </div>
      <a href="contato" class="btn btn-primary bg-purple">Jogar</a>
  ...
  <div class="col">
    <div class="card h-100 container-fluid bg-dark">
      ...
      <div class="card-body">
        ...
        <p class="card-text" style="color:#BEBEBE">Dos mesmos criadores de Absolver, o aclamado jogo de luta para PS4,
          desta vez a Sloclap nos brinda com Sifu, onde acompanhamos a vingança de um jovem aprendiz de kung fu contra
          os assassinos de sua família. É um contra todos, sem nenhum aliado e com inúmeros inimigos.</p>
      </div>
      <a href="contato" class="btn btn-primary bg-purple">Jogar</a>
      <div class="card-footer">
  ...
  <div class="col">
    <div class="card h-100 container-fluid bg-dark">
      ...
      <div class="card-body">
        ...
        <p class="card-text" style="color:#BEBEBE;">Experimente novamente o jogo aclamado pela crítica e definidor de
          gênero que foi o início de tudo. Belamente remasterizado, volte a Lordran com detalhes impressionantes</p>
      </div>
      <a href="contato" class="btn btn-primary bg-purple">Jogar</a>
      <div class="card-footer">
        <small class="text-body-secondary text-white">Desenvolvedores: FromSoftware, Bandai Namco</small>
      </div>
    </div>
  </div>
  <div class="col">
